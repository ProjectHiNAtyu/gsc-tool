...
context::context(gsc::instance inst) : gsc::context(props::str4 | props::tok4 | props::waitframe | props::params | props::boolfuncs | props::boolnotand | props::offs8 | props::extension,
